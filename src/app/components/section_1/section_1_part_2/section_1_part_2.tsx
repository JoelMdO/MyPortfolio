...
//
const CssAnimationLeft = dynamic(() => import("./cssAnimationLeft"), {
  ssr: false,
});
const CssAnimationRight = dynamic(() => import("./cssAnimationRight"), {
  ssr: false,
});
const CssAnimationName = dynamic(() => import("./cssAnimationName"), {
  ssr: false,
});
//
...
const Section1_Part2: React.FC<Section1_Part2Props> = ({ scrollToNext }) => {
  //
  const [isAnimationCSSEnded, setIsAnimationCSSEnded] =
  ...
  return (
    <>
      <div className="bg-black w-full h-screen flex relative">
        ...
        <CssAnimationWelcomeText
          setIsAnimationCSSEnded={setIsAnimationCSSEnded}
        />
      </div>
    </>
  );
